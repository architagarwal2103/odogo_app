...
const List<DropoffLocation> iitkDropoffLocations = <DropoffLocation>[
  ...
  DropoffLocation(name: 'Open Air Theatre', latitude: 26.5053, longitude: 80.2298, aliases: <String>['oat', 'new sac', 'dominos', 'burger', 'stage', 'yoga', 'mpr', 'new shopping complex', 'gym']),
  ...
  DropoffLocation(name: 'Hall 5', latitude: 26.5096, longitude: 80.2290, aliases: <String>['h5', 'tennis', 'cycle', 'repair']),
  ...
  DropoffLocation(name: 'Hall 9', latitude: 26.5080, longitude: 80.2272, aliases: <String>['h9', 'cycle', 'repair']),
  ...
  DropoffLocation(name: 'Hall 12', latitude: 26.5117, longitude: 80.2282, aliases: <String>['h12', 'cycle', 'repair', 'temple']),
  ...
  DropoffLocation(name: 'Old Sports Complex', latitude: 26.5085, longitude: 80.2313, aliases: <String>['sports', 'complex', 'old sports complex', 'gym']),
  DropoffLocation(name: 'Old Shopping Complex', latitude: 26.5114, longitude: 80.2364, aliases: <String>['old', 'shop', 'restaurant', 'sbi', 'd shop', 'tarun bookstore', 'dry cleaner', 'divyam', 'tadka', 'campus restaurant', 'salon', 'barber',]),
  DropoffLocation(name: 'New Shopping Complex', latitude: 26.5044, longitude: 80.2314, aliases: <String>['eshop', 'zing', 'ashiyana', 'amul', 'dry cleaner', 'clothes', 'salon', 'barber']),
  ...
  DropoffLocation(name: 'MT', latitude: 26.5122, longitude: 80.2306, aliases: <String>['mt', 'cycle', 'repair']),
